        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form data-parsley-validate class="form-horizontal" role="form" method="POST" action="{{ url('/newdoctor') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('aadhar') ? ' has-error' : '' }}">
                            <label for="pan" class="col-md-4 control-label">Aadhar Number</label>
                            <div class="col-md-6">
                                <input id="aadhar" type="text"   data-parsley-pattern="/^([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}?$/" style="text-transform: uppercase;" class="form-control" name="aadhar" value="{{ old('pan') }}" maxlength="12" data-parsley-pattern-message="*Invalid Aadhar Number" placeholder="Aadhar Number">
                                @if ($errors->has('pan'))
                                    <span class="help-block">
